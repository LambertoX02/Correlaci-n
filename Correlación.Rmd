...
date: "2024-02-26"
---
nuevo_dir <- "C:/Ejercicios/Correlación"
setwd(nuevo_dir)
...
```{r echo = T}
library(readxl)
data = as.data.frame(read_excel("C:/Ejercicios/Correlación/data.xlsx"))
data
```
...
No. Ya que un muestral tan reducido no puede generar un gran abanico de datos de confianza, siendo inapropiado.